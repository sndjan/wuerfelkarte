...
export const gamemodes: Record<string, GamemodeConfig> = {
  ...
  WunderPlus: {
    ...
    fields: [
      { key: "Einser", label: "Einser", options: [1, 2, 3, 4, 50] },
      { key: "Zweier", label: "Zweier", options: [2, 4, 6, 8, 50] },
      { key: "Dreier", label: "Dreier", options: [3, 6, 9, 12, 50] },
      { key: "Vierer", label: "Vierer", options: [4, 8, 12, 16, 50] },
      { key: "Fünfer", label: "Fünfer", options: [5, 10, 15, 20, 50] },
      { key: "Sechser", label: "Sechser", options: [6, 12, 18, 24, 50] },
      {
        key: "Dreierpasch",
        label: "Dreierpasch",
        options: [...allKniffel, 50],
      },
      {
        key: "Viererpasch",
        label: "Viererpasch",
      ...
      { key: "Große Straße", label: "Große Straße", options: [40] },
      { key: "Wunder", label: "Wunder", options: [50] },
      { key: "Chance", label: "Chance", options: [...allKniffel, 50] },
    ],
    bonus: {
      label: "",
      fields: ["Einser", "Zweier", "Dreier", "Vierer", "Fünfer", "Sechser"],
